      ...
      public class Config {
            ...
            public static void ReadFile() {
                  if (File.Exists(configFileName)) {
                        ...
                        Log.Write(Log.Mode.Info, $"The file \"{configFileName}\" does not exist. Loading default configuration.");
                  }
            }
            ...
            public bool ImportConfigData(string data) {
                  ...
                  if (dataPoints.Length <= 1) {
                        Log.Write(Log.Mode.Warn, "The received import data is too short");
                        return false;
                  }

                  Log.Write(Log.Mode.Verbose, $"Received {dataPoints.Length} datapoints from import string");
                  ...
                  for (int i = 0; i < dataPoints.Length; i++) {
                        ...
                        switch (i) {
                              ...
                              case 14:
                                    ...
                                    break;
                              default:
                                    Log.Write(Log.Mode.Warn, $"The app received too many data points. Received: {dataPoints.Length}, Max expected: {maxExpectedDataPoints}");
                                    quit = true;
                                    break;
                        }
